...
seeding_t *seeding_new(unsigned int seed_size);
...
qreads_t *qreads_new(size_t num_reads);

void qreads_free(qreads_t *qreads);

int qreads_insert(char *name, char *sequence, char *quality);

//------------------------------------------------------------------------------------

//void bwt_gpu(array_list_t *reads, bwt_optarg_t *optarg, bwt_context_t *context, 
//	     array_list_t *unmapped_reads, array_list_t *mapped_reads);

void bwt_cpu(array_list_t *reads, bwt_optarg_t *optarg, bwt_context_t *context, 
	     array_list_t *unmapped_reads, array_list_t *mapped_reads);

*/


unsigned int bwt_single_read_cpu(fastq_read_t *read, bwt_optarg_t *optarg, bwt_index_t *index, 
				 void *mappings) {
