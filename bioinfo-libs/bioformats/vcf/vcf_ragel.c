...
#line 7 "vcf_ragel.c"
static const int vcf_start = 105;
static const int vcf_first_final = 105;
static const int vcf_error = 0;

static const int vcf_en_main = 105;
