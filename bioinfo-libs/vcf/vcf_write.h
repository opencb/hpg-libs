 ...
 * 
 * @param vcf_file The structure to be serialized to file
 * @param fd The descriptor of the file to serialize to
 * @return 0 if the file was successfully written, -i if the i-th argument is NULL
 * 
 * Writes a whole VCF file given a structure stored in main memory. This process consists on 
 ...
 * 
 * @param vcf_file The file whose header will be serialized
 * @param fd The descriptor of the file to serialize to
 * @return void
 * 
 * Writes a VCF header to the given file descriptor. A header contains a declaration of the 
 ...
 * 
 * @param vcf_file The file whose file format will be serialized
 * @param fd The descriptor of the file to serialize to
 * @return void
 * 
 * Writes the information about the format of a VCF file.
 **/
 ...
 * @return void
 * 
 * Writes an entry of the header of a VCF file. As entry can be of the form:
 * 
 ...
 * 
 * @param vcf_file The file whose delimiter will be serialized
 * @param fd The descriptor of the file to serialize to
 * @return void
 * 
 * Writes the line that delimits the end of the header and the beginning of the body of a VCF file. 
 ...
 * 
 * @param vcf_batch The batch whose records will be serialized
 * @param fd The descriptor of the file to serialize to
 * @return void
 * 
 * Writes a batch of VCF records to the given file descriptor. The fact that the records are grouped 
 ...
 * 
 * @param vcf_record The record that will be serialized
 * @param fd The descriptor of the file to serialize to
 * @return void
 * 
 * Writes a record to the given file descriptor, including all its basic fields and the data 
